...
def joint_probability(people, one_gene, two_genes, have_trait):
    ...
    for person in people:
        ...
        have_parents = mother is not None and father is not None
        
        # acá calcularíamos prob_gene
        if not have_parents:
            ...
            p_m = pass_prob(mother_genes)
            p_f = pass_prob(father_genes)
...
def normalize(probabilities):
    ...
    for person in probabilities:
        ...
        for g in probabilities[person]["gene"]:
            probabilities[person]["gene"][g] /= total_genes
